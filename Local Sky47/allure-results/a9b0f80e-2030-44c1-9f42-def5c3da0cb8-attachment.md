      ...
      - generic [ref=e72]:
        ...
        - generic [ref=e91]:
          - table [ref=e94]:
            ...
            - rowgroup [ref=e105]:
              - row "Select row New User user_ctunvui2@example.com admin active -" [ref=e106] [cursor=pointer]:
                ...
                - cell "user_ctunvui2@example.com" [ref=e111] [cursor=pointer]:
                  - generic [ref=e112] [cursor=pointer]: user_ctunvui2@example.com
                ...
                - cell [ref=e120] [cursor=pointer]:
                  - generic [ref=e121] [cursor=pointer]:
                    ...
                    - button [ref=e123] [cursor=pointer]:
                      - img
              - row "Select row Admintwo o1d2admin@yopmaiil.com admin active -" [ref=e124] [cursor=pointer]:
                - cell "Select row" [ref=e125] [cursor=pointer]:
                  - checkbox "Select row" [ref=e126]
                - cell "Admintwo" [ref=e127] [cursor=pointer]:
                  - generic [ref=e128] [cursor=pointer]: Admintwo
                - cell "o1d2admin@yopmaiil.com" [ref=e129] [cursor=pointer]:
                  - generic [ref=e130] [cursor=pointer]: o1d2admin@yopmaiil.com
                ...
                - cell [ref=e138] [cursor=pointer]:
                  - generic [ref=e139] [cursor=pointer]:
                    ...
                    - button [ref=e141] [cursor=pointer]:
                      - img
              - row "Select row AdminOne o1d1admin@yopmail.com admin active -" [ref=e142] [cursor=pointer]:
                - cell "Select row" [ref=e143] [cursor=pointer]:
                  - checkbox "Select row" [ref=e144]
                - cell "AdminOne" [ref=e145] [cursor=pointer]:
                  - generic [ref=e146] [cursor=pointer]: AdminOne
                - cell "o1d1admin@yopmail.com" [ref=e147] [cursor=pointer]:
                  - generic [ref=e148] [cursor=pointer]: o1d1admin@yopmail.com
                ...
                - cell [ref=e156] [cursor=pointer]:
                  - generic [ref=e157] [cursor=pointer]:
                    ...
                    - button [ref=e159] [cursor=pointer]:
                      - img
              - row "Select row Dep daniqa2@yopmail.com admin active -" [ref=e160] [cursor=pointer]:
                - cell "Select row" [ref=e161] [cursor=pointer]:
                  - checkbox "Select row" [ref=e162]
                - cell "Dep" [ref=e163] [cursor=pointer]:
                  - generic [ref=e164] [cursor=pointer]: Dep
                - cell "daniqa2@yopmail.com" [ref=e165] [cursor=pointer]:
                  - generic [ref=e166] [cursor=pointer]: daniqa2@yopmail.com
                ...
                - cell [ref=e174] [cursor=pointer]:
                  - generic [ref=e175] [cursor=pointer]:
                    ...
                    - button [ref=e177] [cursor=pointer]:
                      - img
              - row "Select row QA Danis daniqa@yopmail.com user active -" [ref=e178] [cursor=pointer]:
                - cell "Select row" [ref=e179] [cursor=pointer]:
                  - checkbox "Select row" [ref=e180]
                - cell "QA Danis" [ref=e181] [cursor=pointer]:
                  - generic [ref=e182] [cursor=pointer]: QA Danis
                - cell "daniqa@yopmail.com" [ref=e183] [cursor=pointer]:
                  - generic [ref=e184] [cursor=pointer]: daniqa@yopmail.com
                - cell "user" [ref=e185] [cursor=pointer]:
                  - generic [ref=e186] [cursor=pointer]: user
                ...
                - cell [ref=e192] [cursor=pointer]:
                  - generic [ref=e193] [cursor=pointer]:
                    ...
                    - button [ref=e195] [cursor=pointer]:
                      - img
              - row "Select row Joseph Farisss joseph1@yopmail.com admin active -" [ref=e196] [cursor=pointer]:
                - cell "Select row" [ref=e197] [cursor=pointer]:
                  - checkbox "Select row" [ref=e198]
                - cell "Joseph Farisss" [ref=e199] [cursor=pointer]:
                  - generic [ref=e200] [cursor=pointer]: Joseph Farisss
                - cell "joseph1@yopmail.com" [ref=e201] [cursor=pointer]:
                  - generic [ref=e202] [cursor=pointer]: joseph1@yopmail.com
                ...
                - cell [ref=e210] [cursor=pointer]:
                  - generic [ref=e211] [cursor=pointer]:
                    ...
                    - button [ref=e213] [cursor=pointer]:
                      - img
              - row "Select row Fawad Mehmood fawad1@yopmail.com admin inactive -" [ref=e214] [cursor=pointer]:
                - cell "Select row" [ref=e215] [cursor=pointer]:
                  - checkbox "Select row" [ref=e216]
                - cell "Fawad Mehmood" [ref=e217] [cursor=pointer]:
                  - generic [ref=e218] [cursor=pointer]: Fawad Mehmood
                - cell "fawad1@yopmail.com" [ref=e219] [cursor=pointer]:
                  - generic [ref=e220] [cursor=pointer]: fawad1@yopmail.com
                - cell "admin" [ref=e221] [cursor=pointer]:
                  - generic [ref=e222] [cursor=pointer]: admin
                - cell "inactive" [ref=e223] [cursor=pointer]:
                  - generic [ref=e224] [cursor=pointer]: inactive
                ...
                - cell [ref=e228] [cursor=pointer]:
                  - generic [ref=e229] [cursor=pointer]:
                    ...
                    - button [ref=e231] [cursor=pointer]:
                      - img
              - row "Select row SKY-47 Admin admin@sky47.com admin active -" [ref=e232] [cursor=pointer]:
                - cell "Select row" [ref=e233] [cursor=pointer]:
                  - checkbox "Select row" [ref=e234]
                - cell "SKY-47 Admin" [ref=e235] [cursor=pointer]:
                  - generic [ref=e236] [cursor=pointer]: SKY-47 Admin
                - cell "admin@sky47.com" [ref=e237] [cursor=pointer]:
                  - generic [ref=e238] [cursor=pointer]: admin@sky47.com
                ...
                - cell [ref=e246] [cursor=pointer]:
                  - generic [ref=e247] [cursor=pointer]:
                    ...
                    - button [ref=e249] [cursor=pointer]:
                      - img
          - generic [ref=e250]:
            - navigation "Pagination" [ref=e251]:
              - listitem:
                - button "Previous page" [disabled]:
                  - img "Previous page"
              - listitem [ref=e252]:
                - button "Page 1 is your current page" [ref=e253] [cursor=pointer]: "1"
              - listitem:
